...
const ORDERS = [
  {
    ...
    totalAmount: 17.0,
    totalTracking: 1,
    orderNo: "HEOYCE016230002",
    taxAmount: 1.19,
    grandTotal: 18.19,
    userId: "1c0fe797-ca28-4af7-93fb-b2278980bc38",
    pickupAddressId: "7fa2debf-4292-4be0-a9d6-630c0af297d1",
    status: "Unpaid",
    createdDate: "2023-04-01T16:34:48.893",
  },
  {
    id: "6a0d3e76-ac11-45f3-9674-9da39b683122",
    totalAmount: 17.0,
    totalTracking: 1,
    orderNo: "HEOYCE016230001",
    taxAmount: 1.19,
    grandTotal: 18.19,
    userId: "1c0fe797-ca28-4af7-93fb-b2278980bc38",
    pickupAddressId: "7fa2debf-4292-4be0-a9d6-630c0af297d1",
    status: "Unpaid",
    createdDate: "2023-04-01T01:05:15.097",
  },
  {
  ...
  {
    id: "d3fde5c8-1c8a-4822-9931-68911d7ee5651322",
    totalAmount: 17.0,
    totalTracking: 1,
    orderNo: "HEOYCE016230002",
    taxAmount: 1.19,
  ...
  {
    id: "6a0d3e76-ac11-45f3-9674-9da39b6831222333",
    totalAmount: 17.0,
    totalTracking: 1,
    orderNo: "HEOYCE016230001",
    taxAmount: 1.19,
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: (order) => (
          <>
            {handleValidDate(order.row.original.createdDate)},
            <small className="text-muted">
              {" "}
              {handleValidTime(order.row.original.createdDate)}
            </small>
          </>
        ),
      },
      ...
      {
        Header: <div className="text-center">No of Jobs</div>,
        accessor: "totalTracking",
        filterable: false,
        Cell: (cell) => {
          return (
      ...
      {
        Header: <div className="text-center">Grand Total</div>,
        accessor: "grandTotal",
        filterable: false,
        Cell: (cell) => {
          return (
          ...
          return (
            <ul className="list-inline hstack gap-2 mb-0">
              ...
              <li className="list-inline-item edit">
                <Link
                  to="/apps-ecommerce-create-order"
                    ...
                    <div className="d-flex gap-1 flex-wrap">
                      <button
                        ...
                        onClick={() => {
                          // setIsEdit(false);
                          // toggle();
                          navigate("/apps-ecommerce-create-order");
                        }}
                      >
