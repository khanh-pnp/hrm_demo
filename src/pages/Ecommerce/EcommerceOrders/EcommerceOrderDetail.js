        ...
        <Row>
          <Col xl={9}>
            <Card>
              ...
              <CardBody>
                <div className="table-responsive table-card">
                  <table className="table table-nowrap align-middle table-borderless mb-0">
                    ...
                    <tbody className="border-bottom border-bottom-dashed">
              ...
              <div className="d-flex flex-row justify-content-end mt-3 px-3">
                <div className="d-flex flex-column">
                  <p>Sub Total:</p>
                  <p>
                    Discount <span className="text-muted">(Team0315)</span>:
                  </p>
                  <p>Shipping Charge:</p>
                  <p>Total (USD):</p>
                </div>
                <div className="d-flex flex-column text-end ms-5">
                  <p className="fw-medium">$359.96</p>
                  <p className="fw-medium">-$53.99</p>
                  <p className="fw-medium">$44.99</p>
                  <p className="fw-medium">$415.96</p>
                </div>
              </div>
            </Card>
            ...
            <Card>
              ...
              <CardBody>
                <div className="text-center">
                  ...
                  <p className="text-muted mb-0">Driver Name: HUPER</p>
                </div>
              </CardBody>
            </Card>
